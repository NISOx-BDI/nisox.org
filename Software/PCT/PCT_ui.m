...
% @(#)PCT_ui.m	1.10 T. Nichols 02/06/18
%
...
if nargin==0
  ...
  spm('alert',str,'PCT_ui parameters',1,0);
  ...
  PCT(Vs,Mn,nsd,ta,fullfile(swd,'ResRMS_PCT'))
  PCT(Vs,VMn,nsd,ta,fullfile(swd,'PCT'))
